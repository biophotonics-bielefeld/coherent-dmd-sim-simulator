...
public class TwoColAnalyzer implements PlugIn {
    ...
    public void run(String arg) {
        ...
        Map<String, String> phiOut2Meta = DmdSimulationCore.MetaData.infoStringToMap(phiOut2.getInfoProperty());
        Map<String, String> thetaOut2Meta = DmdSimulationCore.MetaData.infoStringToMap(thetaOut2.getInfoProperty());
        Map<String, String> epd2Meta = DmdSimulationCore.MetaData.infoStringToMap(epd2.getInfoProperty());
